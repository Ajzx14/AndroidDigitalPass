...
public class FiveFragment extends Fragment implements ContactsAdapter.ContactsAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchbar = view.findViewById(R.id.search_bar1); // inititate a search view
...
//        progressDialog.show();
        ...
        DatabaseReference zone1Ref = zonesRef.child("GIT");
    ...
    private void GoToImage(final String fname_, final String lname_, final String mname_, final String mobile_, final String email_, final String paidtill_, final String route_, final String bustype_, final String stand_1,final String college_profile) {
        ...
        islandRef.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                Contact data = new Contact(fullname,Image_list,mobile_,"GIT");
